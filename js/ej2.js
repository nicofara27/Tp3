...
document.write(
  `El primer elemento del arreglo es ${ciudades[0]}, el tercero es ${
    ciudades[2]
  } y el ultimo es ${ciudades[ciudades.length - 1]}<br>`
);
// Añade en última posición la ciudad de París.
ciudades.push(`Paris`);
document.write(
  `El ultimo elemnto del arreglo ahora es ${ciudades[ciudades.length - 1]}<br>`
);
